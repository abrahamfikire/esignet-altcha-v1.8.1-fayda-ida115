                ...
                {config['outline_dropdown'] ? (
                  ...
                  <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild>
                      <span
                        className="inline-flex items-center justify-center bg-[#0F4356] outline-none hover:cursor-pointer text-[14px] text-white !px-5 rounded-full py-1.5"
                    ...
                    <DropdownMenu.Portal>
                      <DropdownMenu.Content
                        className="min-w-[220px] bg-[#0F4356] rounded-md shadow-md will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade px-3 py-2 border border-[#BCBCBC] outline-0 relative top-[-0.5rem] text-white"
                        sideOffset={5}
                      >
