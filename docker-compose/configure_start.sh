...
if [ -d /verifayda-assets/images ]; then
  cp -f /verifayda-assets/images/* "$workingDir/images/" 2>/dev/null || true
fi
if [ -f /verifayda-assets/logo.png ]; then
  cp -f /verifayda-assets/logo.png "$workingDir/logo.png"
  cp -f /verifayda-assets/logo.png "$workingDir/images/brand_logo.png"
  cp -f /verifayda-assets/logo.png "$workingDir/images/logo.png"
elif [ -f /verifayda-assets/images/logo.png ]; then
  cp -f /verifayda-assets/images/logo.png "$workingDir/logo.png"
  cp -f /verifayda-assets/images/logo.png "$workingDir/images/brand_logo.png"
  cp -f /verifayda-assets/images/logo.png "$workingDir/images/logo.png"
fi
if [ -f /verifayda-assets/footer_logo.png ]; then
  cp -f /verifayda-assets/footer_logo.png "$workingDir/images/footer_logo.png"
fi
if [ -f /verifayda-assets/demo-client-logo.png ]; then
  cp -f /verifayda-assets/demo-client-logo.png "$workingDir/images/demo-client-logo.png"
fi
if [ -f /verifayda-assets/images/totp_icon.png ]; then
  cp -f /verifayda-assets/images/totp_icon.png "$workingDir/images/totp_icon.png"
fi
...
if [ -f /verifayda-assets/images/top_logo.png ]; then
  cp -f /verifayda-assets/images/top_logo.png "$workingDir/images/top_logo.png"
fi
...
if [ -f /verifayda-assets/totp-setup.js ]; then
  cp -f /verifayda-assets/totp-setup.js "$workingDir/totp-setup.js"
fi
if [ -f /verifayda-assets/verifayda-ui-fix.js ]; then
  cp -f /verifayda-assets/verifayda-ui-fix.js "$workingDir/verifayda-ui-fix.js"
fi
