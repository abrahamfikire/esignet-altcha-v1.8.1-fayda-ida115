...
public class TokenServiceTest {
    ...
    @Test
    public void verifyClientAssertionToken_withOptionalMissingJTI_thenPass() throws JOSEException {
        JWSSigner signer = new RSASSASigner(RSA_JWK.toRSAPrivateKey());
        JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
                .subject("client-id")
                .audience("audience")
        ...
        tokenService.verifyClientAssertionToken("client-id",
                RSA_JWK.toPublicJWK().toJSONString(), jwt.serialize(),
                List.of("audience"), false);
    }
